#!/usr/bin/env bash
# Self-contained environment for the set-world-settings skill (RUNTIME/client).
...
#   TM_PORT        Traffic Manager port to keep in sync (default 8000)
